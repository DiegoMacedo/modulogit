 ...
 * @author macedo
 */
public class SaidaDeMateriais extends javax.swing.JFrame {

    private DefaultTableModel modelo = new DefaultTableModel();
    Material material = new Material();
    MaterialMb mb = new MaterialMb();

    public SaidaDeMateriais() {
        initComponents();
        ordenarPorId(modelo);
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(btnDecrementar, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaidaDeMateriais.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SaidaDeMateriais().setVisible(true);
            }
        });
    }
