 ...
 * @author macedo
 */
public class EntradaDeMedicamentos extends javax.swing.JFrame {

    private DefaultTableModel modelo = new DefaultTableModel();
    Medicamento medicamento = new Medicamento();
    MedicamentoMb mb = new MedicamentoMb();

    public EntradaDeMedicamentos() {
        initComponents();
        ordenarPorId(modelo);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntradaDeMedicamentos.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntradaDeMedicamentos().setVisible(true);
            }
        });
    }
